...
config ={
  ...
  'modelParams' : {'sensorParams': {'encoders': {u'sine': {'maxval': 1.0, 'name': 'sine', 'clipInput': True, 'minval': -1.0, 'n': 218, 'fieldname': 'sine', 'w': 21, 'type': 'ScalarEncoder'}}}, 'spParams': {'synPermInactiveDec': 0.09885699629937375}, 'tpParams': {'minThreshold': 10, 'activationThreshold': 12, 'pamLength': 2}, 'clParams': {'alpha': 0.025848467384421286}},
