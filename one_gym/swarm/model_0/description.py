...
config ={
  ...
  'modelParams' : {'sensorParams': {'encoders': {'_classifierInput': {'maxval': 53.0, 'classifierOnly': True, 'minval': 0.0, 'clipInput': True, 'n': 67, 'fieldname': 'kw_energy_consumption', 'w': 21, 'type': 'ScalarEncoder'}, u'timestamp_timeOfDay': {'name': 'timestamp', 'fieldname': 'timestamp', 'timeOfDay': (21, 1.0024781365542386), 'type': 'DateEncoder'}, u'timestamp_dayOfWeek': {'dayOfWeek': (21, 1), 'name': 'timestamp', 'fieldname': 'timestamp', 'type': 'DateEncoder'}, u'kw_energy_consumption': None, u'timestamp_weekend': None}}, 'spParams': {'synPermInactiveDec': 0.09554583866372225}, 'tpParams': {'minThreshold': 9, 'activationThreshold': 12, 'pamLength': 1}, 'clParams': {'alpha': 0.005752207047992033}},
