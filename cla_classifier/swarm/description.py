...
control = {
  ...
  'dataset' : {   u'info': u'kw_energy_consumption',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'Rec Center',
                            u'source': u'file://datasets/rec-center-hourly.csv'}],
        u'version': 1},
 ...
 u'predictionSteps': [1]},
  ...
  'metrics':[
    MetricSpec(field=u'category', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'category', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
